...
public class ShadowLayout extends FrameLayout {
    public static final String TAG = ShadowLayout.class.getSimpleName();
    ...
    public ShadowLayout(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShadowLayout(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, 0, 0);
    }

    public ShadowLayout(@NonNull Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
